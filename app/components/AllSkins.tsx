...
interface AllSkinsProps {
    allItems: FormattedItem[],
    rarities: TypesCosmetics
}


export const AllSkins = ({ allItems, rarities }: AllSkinsProps) => {
    ...
    return (
        <>  <div className='flex gap-4 flex-wrap  justify-between items-center'>
            ...
            <input
                name='searchSkin' placeholder='Jinx Arcane' className='bg-yellowFortnite text-bg-body py-2 px-4 rounded-md outline-none w-[50%] placeholder-black/60' onChange={(e) => {
